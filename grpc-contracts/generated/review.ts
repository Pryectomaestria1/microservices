...
/** Mensajes (Modelamos RECURSOS, no acciones) */
export interface Review {
  id: string;
  /** snake_case para campos como pide la convención */
  courseId: string;
  userId: string;
  rating: number;
  comment: string;
...
/** Servicio de Reseñas (PascalCase como recomiendan las diapositivas) */

export interface ReviewServiceClient {
  /** Flujo Unary (1 petición -> 1 respuesta) */
